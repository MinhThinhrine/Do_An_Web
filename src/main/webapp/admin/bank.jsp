...
<head>
    <title>Quản lí hệ thống thanh toán</title>
...
<section id="container">
    ...
    <section id="main-content">
        ...
        <div style="height: 500px;  ">
            <div style=" width: 500px; background: #eeeeee;border: 5px solid rgba(0,255,234,0.41);line-height: 50px " class="container py-5">
                <div  >
                    <div >
                        <div  >
                            <div>
                                <div style="font-size: 20px;color: green;text-align: center;margin-top: 15px;font-family: 'Times New Roman'">PHƯƠNG THỨC THANH TOÁN (Đang cập nhật)
                                </div>
                                <div style="display: flex">
                                    ...
                                    <div>
                                        <p>
                                            <b style="font-size: 25px">Visa</b>
                                        </p>
                                    </div>
                                </div>
                                <div style="display: flex">
                                    <div style="margin-left: 90px;margin-right: 40px">
                                        <i class="fab fa-cc-paypal fa-4x text-black pe-3"></i>
                                    </div>
                                    <div>
                                        <p>
                                            <b style="font-size: 25px">Paypal</b>
                                        </p>
                                    </div>
                                </div>
                                <div style="display: flex">
                                    <div style="margin-left: 90px;margin-right: 40px">
                                        <i class="fab fa-cc-mastercard fa-4x text-black pe-3"></i>
                                    </div>
                                    <div>
                                        <p>
                                            <b style="font-size: 25px">Credit Card</b>
                                        </p>
                                    </div>
                                </div>
